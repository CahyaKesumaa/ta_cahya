<div {{ $attributes->merge(['class' => 'fixed inset-0 z-50 flex items-center justify-center overflow-y-auto overflow-x-hidden bg-gray-400/50 backdrop-blur-md dark:bg-gray-900/80 p-4 md:p-6']) }} x-show="open"

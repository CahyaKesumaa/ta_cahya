<div>
    ...
    <!-- Modal -->
    <div class="fixed inset-0 items-center justify-center hidden p-5 overflow-y-auto modal z-50" id="eventModal">
        <div class="modal-close-btn fixed inset-0 h-full w-full bg-gray-400/50 dark:bg-gray-900/80 backdrop-blur-md">
        </div>
        <div
            class="modal-dialog relative flex w-full max-w-[700px] flex-col overflow-y-auto rounded-3xl bg-white p-6 lg:p-11 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-2xl">

            <!-- Close Button -->
            <button
                class="modal-close-btn transition-color absolute top-5 right-5 z-10 flex h-8 w-8 items-center justify-center rounded-full bg-gray-100 text-gray-400 hover:bg-gray-200 hover:text-gray-600 sm:h-11 sm:w-11 dark:bg-white/[0.05] dark:text-gray-400 dark:hover:bg-white/[0.07] dark:hover:text-gray-300">
            ...
            <div class="flex flex-col px-2 overflow-y-auto modal-content custom-scrollbar">
                ...
                <div class="flex items-center gap-3 mt-6 modal-footer sm:justify-end">
                    ...
                    <button type="button"
                        class="btn btn-update-event bg-blue-600 hover:bg-blue-700 flex w-full justify-center rounded-lg px-4 py-2.5 text-sm font-medium text-white sm:w-auto"
                        style="display: none;" data-fc-event-public-id="">
                        Update Changes
                    </button>
                    <button type="button"
                        class="btn btn-add-event bg-blue-600 hover:bg-blue-700 flex w-full justify-center rounded-lg px-4 py-2.5 text-sm font-medium text-white sm:w-auto">
                        Add Event
                    </button>
                </div>
